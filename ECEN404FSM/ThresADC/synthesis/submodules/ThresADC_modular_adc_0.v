...
module ThresADC_modular_adc_0 (
		...
		output wire        threshold_valid,            //        threshold.valid
		output wire [4:0]  threshold_channel,          //                 .channel
		output wire        threshold_data              //                 .data
	);
	...
	wire         avalon_st_adapter_002_out_0_valid;         // avalon_st_adapter_002:out_0_valid -> threshold_detect_internal:rsp_valid
	wire  [11:0] avalon_st_adapter_002_out_0_data;          // avalon_st_adapter_002:out_0_data -> threshold_detect_internal:rsp_data
	wire   [4:0] avalon_st_adapter_002_out_0_channel;       // avalon_st_adapter_002:out_0_channel -> threshold_detect_internal:rsp_channel
	wire         avalon_st_adapter_002_out_0_startofpacket; // avalon_st_adapter_002:out_0_startofpacket -> threshold_detect_internal:rsp_sop
	wire         avalon_st_adapter_002_out_0_endofpacket;   // avalon_st_adapter_002:out_0_endofpacket -> threshold_detect_internal:rsp_eop
	...
	altera_modular_adc_control #(
		...
		.prescalar                       (0),
		.refsel                          (1),
		.device_partname_fivechar_prefix ("10M04"),
	...
	altera_modular_adc_threshold_detect #(
		.CH_LOW_EN     (18'b000000000000000000),
		.CH_HIGH_EN    (18'b000000000000000111),
		.CH0_LOW_VAL   (12'b000000000000),
		.CH1_LOW_VAL   (12'b000000000000),
		.CH2_LOW_VAL   (12'b000000000000),
		.CH3_LOW_VAL   (12'b000000000000),
		.CH4_LOW_VAL   (12'b000000000000),
		.CH5_LOW_VAL   (12'b000000000000),
		.CH6_LOW_VAL   (12'b000000000000),
		.CH7_LOW_VAL   (12'b000000000000),
		.CH8_LOW_VAL   (12'b000000000000),
		.CH9_LOW_VAL   (12'b000000000000),
		.CH10_LOW_VAL  (12'b000000000000),
		.CH11_LOW_VAL  (12'b000000000000),
		.CH12_LOW_VAL  (12'b000000000000),
		.CH13_LOW_VAL  (12'b000000000000),
		.CH14_LOW_VAL  (12'b000000000000),
		.CH15_LOW_VAL  (12'b000000000000),
		.CH16_LOW_VAL  (12'b000000000000),
		.CH17_LOW_VAL  (12'b000000000000),
		.CH0_HIGH_VAL  (12'b011111000001),
		.CH1_HIGH_VAL  (12'b011111000001),
		.CH2_HIGH_VAL  (12'b011111000001),
		.CH3_HIGH_VAL  (12'b000000000000),
		.CH4_HIGH_VAL  (12'b000000000000),
		.CH5_HIGH_VAL  (12'b000000000000),
		.CH6_HIGH_VAL  (12'b000000000000),
		.CH7_HIGH_VAL  (12'b000000000000),
		.CH8_HIGH_VAL  (12'b000000000000),
		.CH9_HIGH_VAL  (12'b000000000000),
		.CH10_HIGH_VAL (12'b000000000000),
		.CH11_HIGH_VAL (12'b000000000000),
		.CH12_HIGH_VAL (12'b000000000000),
		.CH13_HIGH_VAL (12'b000000000000),
		.CH14_HIGH_VAL (12'b000000000000),
		.CH15_HIGH_VAL (12'b000000000000),
		.CH16_HIGH_VAL (12'b000000000000),
		.CH17_HIGH_VAL (12'b000000000000)
	) threshold_detect_internal (
		.clk             (clock_clk),                                 //      clock.clk
		.rst_n           (reset_sink_reset_n),                        // reset_sink.reset_n
		.rsp_valid       (avalon_st_adapter_002_out_0_valid),         //   response.valid
		.rsp_channel     (avalon_st_adapter_002_out_0_channel),       //           .channel
		.rsp_data        (avalon_st_adapter_002_out_0_data),          //           .data
		.rsp_sop         (avalon_st_adapter_002_out_0_startofpacket), //           .startofpacket
		.rsp_eop         (avalon_st_adapter_002_out_0_endofpacket),   //           .endofpacket
		.threshd_valid   (threshold_valid),                           //  threshold.valid
		.threshd_channel (threshold_channel),                         //           .channel
		.threshd_data    (threshold_data)                             //           .data
	);
	...
	ThresADC_modular_adc_0_avalon_st_adapter #(
		.inBitsPerSymbol (12),
		.inUsePackets    (1),
		.inDataWidth     (12),
		.inChannelWidth  (5),
	...
	ThresADC_modular_adc_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (12),
		.inUsePackets    (1),
		.inDataWidth     (12),
		.inChannelWidth  (5),
